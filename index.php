...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">Tigwel git</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">developpement</a>
          <a class="dropdown-item" href="#">design</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">me contacter</a>
        </div>
      </li>
    ...
    <div class="container">
        ...
        <h1 class="text-center my-5 "> tigwel git </h1>
  ...
  <div class="card-body">
    ...
    <p class="card-text text-center">et moi je préfère les chiens, les gros chiens ! </p>
